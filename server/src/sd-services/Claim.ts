    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          //appendnew_next_sd_nXvv3hKaNrwrVw9J
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_nXvv3hKaNrwrVw9J');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        null,
    ...
    this.app['post'](
      ...
      async (req, res, next) => {
        ...
        try {
          ...
          //appendnew_next_sd_Qc8d8msrOrGRQPN9
        } catch (e) {
          return await this.errorHandler(bh, e, 'sd_Qc8d8msrOrGRQPN9');
        }
      },
      this.sdService.getMiddlesWaresBySequenceId(
        'IDSAuthroizedAPIs',
...
`;
  ...
  async sd_UksgNe5d2MtSphDJ(bh, parentSpanInst) {
    const spanInst = this.tracerService.createSpan(
      'sd_UksgNe5d2MtSphDJ',
      parentSpanInst
    );
    try {
      ...
      //appendnew_next_sd_UksgNe5d2MtSphDJ
      return bh;
    } catch (e) {
      return await this.errorHandler(
        bh,
  ...
  async claimResponse(bh, parentSpanInst) {
   ...
   ========================================================= */
      ...
      if (rows.length === 0) {
       ...
       ===================================================== */
        ...
        bh.local.claimNumber = String(
          rows[0].claim_number || rows[0].claimNumber || ''
        );

        bh.local.oldStatus = String(rows[0].status || '');
      ...
      console.log('==========================================');
      this.tracerService.sendData(spanInst, bh);
      bh = await this.sd_adiRCBCQdG9dfJfN(bh, parentSpanInst);
  ...
  async sd_adiRCBCQdG9dfJfN(bh, parentSpanInst) {
    const spanInst = this.tracerService.createSpan(
      'sd_adiRCBCQdG9dfJfN',
      parentSpanInst
    );
    try {
      if (
        ...
        bh = await this.sd_GJqCbibOiy1u9Y1J(bh, parentSpanInst);
      }
      this.tracerService.sendData(spanInst, bh);
  ...
  async claimNotFoundErrorDecision(bh, parentSpanInst) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_izbOulkkmBEGSPRY');
    }
  }

  async sd_GJqCbibOiy1u9Y1J(bh, parentSpanInst) {
    const spanInst = this.tracerService.createSpan(
      'sd_GJqCbibOiy1u9Y1J',
      parentSpanInst
    );
    try {
      ...
      //appendnew_next_sd_GJqCbibOiy1u9Y1J
      return bh;
    } catch (e) {
      return await this.errorHandler(
        bh,
  ...
  async claimUpdateSuccess(bh, parentSpanInst) {
   ...
   ========================================================= */
      ...
      console.log('==================================');
      this.tracerService.sendData(spanInst, bh);
      bh = await this.sd_gSX5Qup3eGA0mrVX(bh, parentSpanInst);
  ...
  async sd_gSX5Qup3eGA0mrVX(bh, parentSpanInst) {
    const spanInst = this.tracerService.createSpan(
      'sd_gSX5Qup3eGA0mrVX',
      parentSpanInst
    );
    try {
      ...
      this.tracerService.sendData(spanInst, bh);
      bh = await this.sd_h4DOQJf6U3qRKamD(bh, parentSpanInst);
      //appendnew_next_sd_gSX5Qup3eGA0mrVX
      return bh;
    } catch (e) {
      return await this.errorHandler(
        bh,
  ...
  async sd_h4DOQJf6U3qRKamD(bh, parentSpanInst) {
    const spanInst = this.tracerService.createSpan(
      'sd_h4DOQJf6U3qRKamD',
      parentSpanInst
    );
   ...
   ========================================================= */
      ...
      console.log('Correlation ID:', bh.local.correlationId);

      /*
       * SQL node completed without throwing an error.
       * Therefore audit INSERT was successful.
       */

      bh.local.auditInsertSuccess = true;

      console.log('auditInsertSuccess:', bh.local.auditInsertSuccess);
   ...
   ========================================================= */
      ...
      console.log('claimFound:', bh.local.claimFound);
  ...
  async claimDecisionUpdateOut(bh, parentSpanInst) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_7ZQ8LohFIJNdoMqV');
    }
  }
...
`;
  ...
  async fieldMissingError(bh, parentSpanInst) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_KyuCgMnhJNWZQZwO');
    }
  }
  ...
  async policyResultResponse(bh, parentSpanInst) {
    ...
    try {
      ...
      this.tracerService.sendData(spanInst, bh);
      bh = await this.sd_HrSQlY17EwOT4c7m(bh, parentSpanInst);
  ...
  async sd_HrSQlY17EwOT4c7m(bh, parentSpanInst) {
    const spanInst = this.tracerService.createSpan(
      'sd_HrSQlY17EwOT4c7m',
      parentSpanInst
    );
  ...
  async policyNotFoundError(bh, parentSpanInst) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_AriAdl1SaCDAC5lt');
    }
  }
...
`;
  ...
  async checkClaimResult(bh, parentSpanInst) {
    ...
    try {
      ...
      this.tracerService.sendData(spanInst, bh);
      bh = await this.sd_OYldrUdSavQNSwTn(bh, parentSpanInst);
  ...
  async sd_OYldrUdSavQNSwTn(bh, parentSpanInst) {
    const spanInst = this.tracerService.createSpan(
      'sd_OYldrUdSavQNSwTn',
      parentSpanInst
    );
  ...
  async unabletoCreateClaimError(bh, parentSpanInst) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_73scAe0oV9VJ777d');
    }
  }
  ...
  async prepareEvidence(bh, parentSpanInst) {
    ...
    try {
      ...
      this.tracerService.sendData(spanInst, bh);
      bh = await this.sd_9Hkeq5HO61SnRM4H(bh, parentSpanInst);
  ...
  async sd_9Hkeq5HO61SnRM4H(bh, parentSpanInst) {
    const spanInst = this.tracerService.createSpan(
      'sd_9Hkeq5HO61SnRM4H',
      parentSpanInst
    );
  ...
  async prepareCaseCreation(bh, parentSpanInst) {
   ...
   ========================================================= */
      ...
      bh.local.caseCreationRequest = {
        ...
        caseData: {
          ...
          policyId: Number(bh.local.claimPolicyId || bh.local.verifiedPolicyId),
          ...
          driverName: bh.local.driverName,

          driverLicenceStatus: bh.local.driverLicenceStatus,
          ...
          mandatoryDocsComplete: !!bh.local.mandatoryDocsComplete,

          manualReviewOverride: !!bh.local.manualReviewOverride,

          policyStatus: bh.local.policyStatus,
          ...
          coverageValid: !!bh.local.coverageValid,
          ...
          claimAmount: Number(bh.local.claimAmount || 0),

          injuryClear: !!bh.local.injuryClear,

          stpEligible: !!bh.local.stpEligible,

          policyActive: !!bh.local.policyActive,

          evidenceValid: !!bh.local.evidenceValid,

          recommendation: bh.local.recommendation || '',

          policyAgeDays: Number(bh.local.policyAgeDays || 0),

          stpFraudValid: !!bh.local.stpFraudValid,

          policyAgeValid: !!bh.local.policyAgeValid,

          stpAmountValid: !!bh.local.stpAmountValid,

          priorClaimsValid: !!bh.local.priorClaimsValid,

          policeReportValid: !!bh.local.policeReportValid,

          criticalFraudClear: !!bh.local.criticalFraudClear,

          repairEstimateValid: !!bh.local.repairEstimateValid,

          managerAuthorityExceeded: !!bh.local.managerAuthorityExceeded,

          thirdPartyComplexityFlag: !!bh.local.thirdPartyComplexityFlag,

          claimAmountWithinCoverage: !!bh.local.claimAmountWithinCoverage,

          fraudInvestigationRequired: !!bh.local.fraudInvestigationRequired,

          thirdPartyComplexityClear: !!bh.local.thirdPartyComplexityClear,

          lossDateWithinPolicyPeriod: !!bh.local.lossDateWithinPolicyPeriod,
        },
   ...
   ========================================================= */
      ...
      console.log('Case Creation Body:', bh.local.caseCreationBody);
  ...
  async getCaseServiceToken(bh, parentSpanInst) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_wJ6RWVGHyzYOBWlq');
    }
  }
  ...
  async createFnolCase(bh, parentSpanInst) {
    try {
      ...
      return await this.errorHandler(bh, e, 'sd_4QK9mgdnVKSMK6ri');
    }
  }
  ...
  async finalResponseScript(bh, parentSpanInst) {
    ...
    try {
      ...
      console.log('=============================================');
      this.tracerService.sendData(spanInst, bh);
      await this.sd_AMqtto7idEe3g99Q(bh, parentSpanInst);
  ...
  async sd_AMqtto7idEe3g99Q(bh, parentSpanInst) {
    try {
      bh.web.res.status(bh.local.responseStatus).send(bh.local.response);

      return bh;
    } catch (e) {
      return await this.errorHandler(bh, e, 'sd_AMqtto7idEe3g99Q');
    }
  }
